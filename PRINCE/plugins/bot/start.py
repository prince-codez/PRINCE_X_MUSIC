...
from PRINCE.misc import _boot_
from PRINCE.plugins.sudo.sudoers import sudoers_list
from PRINCE.utils.database import (
    add_served_chat,
    add_served_user,
    blacklisted_chats,
    get_lang,
...
from PRINCE.utils.decorators.language import LanguageStart
from PRINCE.utils.formatters import get_readable_time
from PRINCE.utils.inline import help_pannel, private_panel, start_panel
...
async def start_pm(client, message: Message, _):
    ...
    # **🔥 Step 1: Ding.. Dong..❤️‍🔥 Animation**
    typing_message = await message.reply("<b>🔔 𝖣ɪɴ𝗀..𝖣𝗈𝗇𝗀..❤️‍🔥</b>")
    await asyncio.sleep(1.2)  # Hold for effect
    await typing_message.delete()  

    # **🔥 Step 2: Smooth Typing Effect**
    typing_texts = [
        "<b>⚡ s...</b>",
        "<b>⚡ sᴛ...</b>",
        "<b>⚡ sᴛᴀ...</b>",
    ...
    for text in typing_texts:
        typing_message = await message.reply(text)
        await asyncio.sleep(0.2)
        await typing_message.delete()

    # **🔥 Step 3: Hold Message for VIP Feel**
    final_message = await message.reply("<b>🌀 ᴍᴜsɪᴄ ʙᴏᴛ ɪs ɴᴏᴡ ʀᴇᴀᴅʏ 💭</b>")
    await asyncio.sleep(2)
    await final_message.delete() # Delete the message
